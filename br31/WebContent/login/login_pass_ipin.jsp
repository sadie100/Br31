...
<body>
	...
	<div class = "pop_content">
		<form name = "login_pass_phone_form" action = "http://localhost:9000/br31/login/passSearchProcess.jsp?type=ipin" method = "post">
		<input type = "hidden" name = "type" value = "ipin">
			<ul>
				...
				<li class = "ipin_style">
					<label>아이핀</label>
					<input type = "text" name = "ipin" id = "ipin" placeholder = "아이핀 id를 입력해주세요">
				</li>
				<li>
					<label>이메일</label>
