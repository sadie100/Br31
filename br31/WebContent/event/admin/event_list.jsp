...
<%
	...
	ArrayList<EventVO> list = dao.getList(startCount, endCount);
		...
		<section class="board_list">
			...
			<table class="content_layout">
				...
				for (EventVO vo : list) {
					...
					tbody.append("<td>");
					tbody.append("	<a href='event_content.jsp?articleno="+vo.getArticleno()+"&rno=" + vo.getRno() + "'>" + vo.getTitle() + "</a>");
					tbody.append("</td>");
