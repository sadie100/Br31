			...
			<form name="voc_answer_form" action="adminVocWriteProcess.jsp" method="post" id="voc_answer_form">
				...
				<div class="answer">
					<table>
						...
						<tr>
							<td>
								<textarea class="voc_answer" id="voc_answer" name="answer"></textarea>
							</td>
						</tr>
					</table>
				</div>
				<div class="btn_area">
					<div class="area_left">
						<a><button type="button" id="btnGoBack">목록</button></a>
					</div>
					<div class="area_right">
						<a><button type="button" id="btnAnswerSave">답변등록</button></a>
					</div>
				</div>
			</form>
		</section>	
