...
section.m_page span:first-child{
	color: rgb(255, 124, 152);
}

section.m_page div:first-child{
	margin-bottom: 70px;
	margin-top:-30px;
}
</style>
...
<body>
	...
	<div class = "content">
		<section class = "m_menu">
			...
			<h4>회원님을 위한 배스킨라빈스의 다양한 정보</h4>
				<ul>
					...
					<a href = "mypage_f_shop.jsp"><img src = "http://localhost:9000/br31/images/2st_mypage_onclick.PNG"></a>
		...
		<section class = "m_page">
			<div>
				<span>홍길동</span>
				<span>회원님이 자주 이용하시는 매장리스트 입니다.</span>
			</div>
		</section>
	</div>
	<!-- content -->
